...
<html class="no-js" lang="zxx">
    ...
    <body>
                        ...
                        <div class="col-lg-8 col-md-8 col-12">
                            <div class="account-curr-lang-wrap f-right">
                                <ul>
                                    ...
                                    <li><a href="#"><img alt="flag" src="{{asset('assets/img/icon-img/en.jpg')}}"> English  <i class="icon-arrow-down"></i></a>
                                        <ul>
                                            <li><a href="#"><img alt="flag" src="{{asset('assets/img/icon-img/bl.jpg')}}">Bangla </a></li>
                                            <li><a href="#"><img alt="flag" src="{{asset('assets/img/icon-img/ar.jpg')}}">Arabic</a></li>
                                            <li><a href="#"><img alt="flag" src="{{asset('assets/img/icon-img/in.jpg')}}">Hindi </a></li>
                                            <li><a href="#"><img alt="flag" src="{{asset('assets/img/icon-img/sp.jpg')}}">Spanish</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                            <div class="logo pt-39">
                                <a href="index.html"><img alt="" src="{{asset('assets/img/logo/logo.png')}}"></a>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mega-menu-position"><a href="shop-page.html">Food</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li>
                                                    <ul>
                                                        <li><a href="shop-page.html"><img alt="" src="{{asset('assets/img/banner/menu-img-4.jpg')}}"></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 col-sm-5">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated" src="{{asset('assets/img/slider/slider-single-img.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-5 col-12">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated" src="{{asset('assets/img/slider/slider-single-img-2.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="deal-img wow fadeInLeft">
                            <a href="#"><img src="{{asset('assets/img/banner/banner-2.png')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="testimonial-wrap">
                            ...
                            <div class="testimonial-image-slider text-center">
                                <div class="sin-testiImage">
                                    <img src="{{asset('assets/img/testi/3.jpg')}}" alt="">
                                    <h3>Robiul Islam</h3>
                                    <h5>Customer</h5>
                                </div>
                                <div class="sin-testiImage">
                                    <img src="{{asset('assets/img/testi/4.jpg')}}" alt="">
                                    <h3>Robiul Islam</h3>
                                    <h5>Customer</h5>
                                </div>
                                <div class="sin-testiImage">
                                ...
                                <div class="sin-testiImage">
                                    <img src="{{asset('assets/img/testi/5.jpg')}}" alt="">
                                    <h3>T. T. Rayed</h3>
                                    <h5>CEO</h5>
                                </div>
                            </div>
                            <div class="testimonial-shap">
                                <img src="{{asset('assets/img/icon-img/testi-shap.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
		        ...
		        <div class="row">
		            <div class="col-lg-4 col-md-4">
		                <div class="service-content text-center mb-30 service-color-1">
		                    <img src="{{asset('assets/img/icon-img/shipping.png')}}" alt="">
		                    <h4>FREE SHIPPING</h4>
		            ...
		            <div class="col-lg-4 col-md-4">
		                <div class="service-content text-center mb-30 service-color-2">
		                    <img src="{{asset('assets/img/icon-img/support.png')}}" alt="">
		            ...
		            <div class="col-lg-4 col-md-4">
		                <div class="service-content text-center mb-30 service-color-3">
		                    <img src="{{asset('assets/img/icon-img/money.png')}}" alt="">
		                    <h4>MONEY RETURN</h4>
		    ...
		    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.html"><img alt="" src="{{asset('assets/img/blog/blog-1.jpg')}}"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.html"><img alt="" src="{{asset('assets/img/blog/blog-2.jpg')}}"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30 gray-bg">
                            <div class="blog-img hover-effect">
                                <a href="blog-details.html"><img alt="" src="{{asset('assets/img/blog/blog-3.jpg')}}"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <ul>
		...
		<!-- all js here -->
        <script src="{{asset('assets/vendor/jquery-1.12.0.min.js')}}"></script>
